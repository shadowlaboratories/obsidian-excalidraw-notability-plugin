...
export default {
  ...
  IMPORT_NOTABILITY_NOTE: "Import Notability .note",
  IMPORT_NOTABILITY_NOTE_RUNNING: "Importing Notability note...",
  IMPORT_NOTABILITY_NOTE_DONE: "Imported Notability note:",
  IMPORT_NOTABILITY_NOTE_FAILED: "Failed to import Notability .note. Check the developer console for details.",
  IMPORT_NOTABILITY_NOTE_DESKTOP_ONLY: "Notability import is only available on desktop",
